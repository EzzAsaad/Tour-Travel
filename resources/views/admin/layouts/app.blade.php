...
<html lang="en">
    <head>
        ...
        <meta name="author" content="logapps">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="#">
                        ...
                        <span class="smini-hide font-size-h5 tracking-wider">
                            Admin<span class="font-w400"></span>
                        </span>
                    </a>
                    <!-- END Logo -->
...
{{--                                                        </a>--}}
                                                    <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{ route('Admin.EditAboutus') }}">
                                                        <i class="nav-main-link-icon si si-bag"></i>
                                                        <span class="nav-main-link-name">{{trans('sidebar.AboutSetting')}}</span>
                                                    </a>
                                                    {{--                                        <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{ route('Admin.EditSettings') }}">--}}
                                                    {{--                                            <i class="nav-main-link-icon si si-bag"></i>--}}
                                ...
                                <?php
                                $files = App\Http\Controllers\Admin\LangController::getAllFiles();
                                ...
                                {{--<li class="nav-main-item">--}}
                                    {{--<a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"  href="#">--}}
                                        {{--<i class="nav-main-link-icon si si-layers"></i>--}}
                                        {{--<span class="nav-main-link-name">{{trans('sidebar.language')}}</span>--}}
                                    {{--</a>--}}
                                    {{--<ul class="nav-main-submenu">--}}
                                        {{--<li class="nav-main-item">--}}
{{--                                            //Admin.Language--}}
                                            ...
                                            {{--?>--}}
                                            {{--<a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{ route('Admin.Language',['filename'=>$filename]) }}">--}}
                                                {{--<i class="nav-main-link-icon si si-bag"></i>--}}
                                                {{--<span class="nav-main-link-name">{{$filename}}</span>--}}
                                            {{--</a>--}}
                                            {{--<?php }?>--}}
                                        {{--</li>--}}
...
{{--                                    </li>--}}
                                ...
                                <li class="nav-main-item">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"  href="#">
                                            <i class="nav-main-link-icon si si-layers"></i>
                                            <span class="nav-main-link-name">{{trans('sidebar.ProgramManagement')}}</span>
                                        </a>
                                        <ul class="nav-main-submenu">
                                            <li class="nav-main-item">
                                                <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{ route('Admin.AddNewProgram') }}">
                                                    <i class="nav-main-link-icon si si-bag"></i>
                                                    <span class="nav-main-link-name">{{trans('sidebar.AddProgram')}}</span>
                                                </a>
                                                <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{route('Admin.listPrograms')}}">
                                                    <i class="nav-main-link-icon si si-bag"></i>
                                                    <span class="nav-main-link-name">{{trans('sidebar.viewPrograms')}}</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"  href="#">
                                            <i class="nav-main-link-icon si si-layers"></i>
                                            <span class="nav-main-link-name">{{trans('sidebar.BookingManagement')}}</span>
                                        </a>
                                        <ul class="nav-main-submenu">
                                            <li class="nav-main-item">
                                                <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{ route('Admin.createBookings') }}">
                                                    <i class="nav-main-link-icon si si-bag"></i>
                                                    <span class="nav-main-link-name">{{trans('sidebar.AddBooking')}}</span>
                                                </a>
                                                <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{route('Admin.listBookings')}}">
                                                    <i class="nav-main-link-icon si si-bag"></i>
                                                    <span class="nav-main-link-name">{{trans('sidebar.viewBookings')}}</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"  href="#">
                                            <i class="nav-main-link-icon si si-layers"></i>
                                            <span class="nav-main-link-name">{{trans('sidebar.PackagesManagement')}}</span>
                                        </a>
                                        <ul class="nav-main-submenu">
                                            <li class="nav-main-item">
                                                <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{route('Admin.createNewPackage')}}">
                                                    <i class="nav-main-link-icon si si-bag"></i>
                                                    <span class="nav-main-link-name">{{trans('sidebar.AddPackage')}}</span>
                                                </a>
                                                <a class="nav-main-link "  aria-haspopup="true" aria-expanded="false" href="{{route('Admin.listAllPackages')}}">
                                                    <i class="nav-main-link-icon si si-bag"></i>
                                                    <span class="nav-main-link-name">{{trans('sidebar.ViewallPackages')}}</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary-dark rounded-top">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{asset("files/user_images/".auth()->user()->image)}}" alt="">
...
{{--                                    </a>--}}
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('Admin.Editemployee', auth()->user()->id) }}">
                                        <span class="font-size-sm font-w500">{{__('settings.profile')}}</span>
...
{{--                                    </a>--}}
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                        ...
                                        <span class="font-size-sm font-w500">{{__('settings.logout')}}</span>
                                    </a>
