                ...
                <div class="p-sm-3 px-lg-4 py-lg-5 {{ App::isLocale('ar')? 'text-right' : 'text-left'  }}">
                    ...
                    @csrf
                        <div class="py-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="">{{ trans('header.addresscompanyAr') }}</label>
                                    <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="address_companyAr" value="{{  $settings->address_companyAr}}" required><br>
                                </div>
                                <div class="col">
                                    <label for="">{{ trans('header.addresscompanyEn') }}</label>
                                    <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="address_companyEn" value="{{ $settings->address_companyEN}}" required> <br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label for="">{{ trans('header.slider_infoAr') }}</label>
                                    <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="slider_infoAr" value="{{$settings->slider_infoAR}}"><br>
                                </div>
                                <div class="col">
                                    <label for="">{{ trans('header.slider_infoEn') }}</label>
                                    <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="slider_infoEn" value="{{ $settings->slider_infoEn}}"> <br>
                                </div>
                            </div>
...
{{--                            </div>--}}
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="">Trip Advisor Link </label>
                                <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="tripadvisorlink" value="{{$settings->tripadvisorlink}}"><br>
                            </div>
                            <div class="col">
                                <label for="">Private Guides gold Sea Link</label>
                                <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="privateguidelink" value="{{ $settings->privateguidelink}}"> <br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <label for="">Banner Title </label>
                                <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="bannertitle" value="{{$settings->bannertitle}}"><br>
                            </div>
                            <div class="col">
                                <label for="">Banner Description</label>
                                <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="bannerdesc" value="{{ $settings->bannerdesc}}"> <br>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Banner Photo</label><br>
                            @if(isset($settings->bannerphoto) && $settings->bannerphoto != '')
                                <img src="{{ asset($settings->bannerphoto) }}" style="width:150px;height:150px;" />
                            @endif
                            <input type="file" class="form-control form-control-alt form-control-lg" id="login-username" name="bannerphoto" >
                        </div>
