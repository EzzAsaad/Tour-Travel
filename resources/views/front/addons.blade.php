...
@section('content')
    <form action='{{ route('Front.savecart',['lang'=>(App::isLocale('ar'))? 'ar' : 'en','prod_id'=>$product->id])}}' method='POST'>
        @csrf
                        ...
                        <table class="table text-center table-cart" @if(App::isLocale('ar'))dir="rtl" @endif>
                            ...
                            <tr id="abId0.888403729209045">
                                <th scope="row" class="text-center">
                                    <img style="width: 105px;height: 105px" src="{{asset($product->image)}}" alt="" class="img-fluid w-25 mr-3">
                                    <?php
                                ...
                                <td>
                                    <select required name="prod_size" onchange="return changeprice(this)" class="form-control">
                                        <option disabled selected value="">{{__('front.selectprodsize')}}</option>
