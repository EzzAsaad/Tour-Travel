                                    ...
                                    @foreach($tours as $tour)
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                            <div class="tg-topdestination">
                                                <figure>
                                                    <a href="{{route('Front.category',['lang'=>(App::isLocale('ar')?"ar":"en"),'id'=>$tour->id])}}" class="tg-btnviewall">View All Programs</a>
                                                    <a href="{{route('Front.category',['lang'=>(App::isLocale('ar')?"ar":"en"),'id'=>$tour->id])}}"><img style="width: 360px;height: 473px;" src="{{asset($tour->image)}}" alt="image description"></a>
                                                    <figcaption>
                                                        <h2><a href="listingvone.html">{{$tour->name}}</a></h2>
                                                        <span class="tg-totaltours">{{$tour->num_tours}} Programs</span>
                                                    </figcaption>
                                                </figure>
                                            </div>
                                        </div>
